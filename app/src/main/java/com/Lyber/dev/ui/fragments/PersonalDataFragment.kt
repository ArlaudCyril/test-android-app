...
class PersonalDataFragment : BaseFragment<FragmentPersonalDataBinding>(), View.OnClickListener {
    ...
    fun checkData(): Boolean {
        when {
            firstName.isEmpty() -> {
                binding.etFirstName.requestKeyboard()
                getString(com.Lyber.dev.R.string.please_enter_your_first_name).showToast(binding.root,requireContext())
            }
            ...
            birthPlace.isEmpty() -> {
                binding.etBirthPlace.requestKeyboard()
                getString(com.Lyber.dev.R.string.please_enter_your_birth_place).showToast(binding.root,requireContext())
            }

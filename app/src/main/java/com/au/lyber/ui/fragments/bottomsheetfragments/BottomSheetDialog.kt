...
//                            "Sell ${it.asset_id.uppercase()} from your wallet"
                ...
                val exchange = View.OnClickListener {
                    listenItemClicked(tag ?: "",DataBottomSheet(1,requireContext().getString(R.string.exchange)))
                    dismiss()
                }

                val deposit = View.OnClickListener {
                    listenItemClicked(tag ?: "",DataBottomSheet(1,requireContext().getString(R.string.deposit)))
                    dismiss()
                }
